...
import peroff from "../../img/25off.png";
import ftvimg from "../../img/ftv.png";
import backgroundimg from "../../img/discountBackGround.jpg";
...
const Home = () => {
            ...
            <section className={`sectionFirst ${menuActive ? "active" : ""}`}>
                <Slider {...settings} style={{ overflow: "hidden" }}>
                    ...
                    >
                        ...
                        <p className="paragra">
                            WE AT FTV SALON INTRODUCE STANDARDIZED SALON GROOMING SERVICES FOR
                            INDIAN CITIZENS.
                            <br />
                            WE ASPIRE TO BECOME THE LEADER OF LUXURY SALON BUSINESS IN INDIA
                            PROVIDING WORLD-CLASS SALON TREATMENT TO OUR CLIENTS.
                        </p>
                        <div className="btn">
            ...
            <section className="sectionSecond">
                ...
                <div className="textInfo">
                    ...
                    <p className="para">
                        ...
                        odio vitae. Voluptatibus deleniti at ullam error, voluptates
                        pariatur quibusdam! Corporis corrupti in molestias consequuntur
                        dolorum eligendi vel animi suscipit!
                    </p>
                </div>
            </section>
            ...
            <section className="sectionThree">
                ...
                <div className="servicesBox">
                    <div className="box">
                        ...
                        <p>
                            A little detail about the services you've mentioned above. Tell
                            them what you do
                        </p>
                    </div>
                    <div className="box">
    ...
    <img src={backgroundimg} alt="Discount Background" className="background-image" />
    
    <div className="img">
        <img src={peroff} alt="25% Off" />
    </div>
    ...
    <Link to="#">BOOK AN APPOINTMENT</Link>
            ...
            <div className="transformBox">
                ...
                <p>
                    ...
                    earum, voluptas consectetur explicabo tempore aut placeat blanditiis
                    dolores dolorum.
                </p>
            </div>
            ...
            <section className="sectionFive">
                <div className="BeautySolutions">
                    ...
                    <ul>
                        <li>
                            Women's Haircut <span>₹ 95</span>
                        </li>
                        <li>
                            Teen's Haircut <span>₹ 40+</span>
                        </li>
                        <li>
                            Stylish Haircut <span>₹ 55</span>
                        </li>
                        <li>
                            Children's Haircut <span>₹ 40+</span>
                        </li>
                    </ul>
                </div>
                <div className="BeautySolutions">
                    ...
                    <ul>
                        ...
                        <li>
                            Teen's Haircut <span>₹ 95</span>
                        </li>
                        <li>
                            Stylish Haircut <span>₹ 95</span>
                        </li>
                        <li>
                            Children's Haircut <span>₹ 95</span>
                        </li>
                    </ul>
                </div>
                <div className="BeautySolutions">
            ...
            <section className="sectionSix">
                ...
                <div className="imgicon">
                    <img src={ftvimg} alt="Testimonial" />
                </div>

                <p>
                    DUE TO FASHIONTV’S BRAND POPULARITY AND OUR CUSTOMERS LOVE TO POST,
                    LIKE, SHARE, COMMENT, CHECK-IN, TAKE PICTURES, SHOOT VIDEOS, TAG, AND
                    MORE IN ALL OF OUR LOCATIONS.
                </p>
            </section>
